...
- ``public abstract class Reader extends Objectimplements Readable, Closeable`` ：抽象类
...
- `public abstract class Writerextends Objectimplements Appendable, Closeable, Flushable`  ：抽象类
...
public class e_FileWriter {
    public static void main(String[] args) throws Exception {
        ...
        fw.write(line_feed+"沧海一声笑");
        fw.write(line_feed+"涛涛两岸潮");
        fw.close();
    }
}
```
