...
//        at com.company.stream.StreamTest.test11(StreamTest.java:321)
...
//        List<String> collect = ss.stream().peek(x -> "--" + x).collect(Collectors.toList());
    ...
    public void streamFromFile () throws IOException {
        Stream<String> lines = Files.lines(Paths.get("C:\\PC\\workspace\\Java\\JavaBase\\src\\main\\java\\com\\company\\stream\\OptionalTest.java"));
