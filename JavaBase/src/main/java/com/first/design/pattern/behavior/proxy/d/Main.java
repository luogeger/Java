package com.first.design.pattern.behavior.proxy.d;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //  必须返回接口类型
        //  Exception in thread "main" java.lang.ClassCastException: com.sun.proxy.$Proxy0 cannot be cast to com.first.design.pattern.behavior.proxy.d.Personnel
