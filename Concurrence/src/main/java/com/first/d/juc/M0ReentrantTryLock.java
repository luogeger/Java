 ...
 */
public class M0ReentrantTryLock {
    ...
    private void ban() {
        ...
        try {
            locked = lock.tryLock(5, TimeUnit.SECONDS);//  抢锁
    ...
    public static void main(String[] args) throws InterruptedException {
        M0ReentrantTryLock entity = new M0ReentrantTryLock();
        new Thread(entity::app, "app").start();
        TimeUnit.SECONDS.sleep(1);
        new Thread(entity::ban, "ban").start();
    }
}
